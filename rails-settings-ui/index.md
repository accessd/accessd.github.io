---
layout: page
title: "User interface to manage settings in your Rails application"
description: "A Rails Engine to manage your application settings. Includes validation. Compatible with Rails 5."
---

<section class="page-header">
<h1 class="project-name">rails-settings-ui</h1>
<h2 class="project-tagline">Simple manage settings in your Rails application</h2>
<a href="https://github.com/accessd/rails-settings-ui" class="btn">View on GitHub</a>
<a href="https://github.com/accessd/rails-settings-ui/zipball/master" class="btn">Download .zip</a>
<a href="https://github.com/accessd/rails-settings-ui/tarball/master" class="btn">Download .tar.gz</a>
</section>
