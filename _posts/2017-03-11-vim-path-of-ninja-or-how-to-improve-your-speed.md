...
можно использовать нетолько в Vim, но и в терминале например. Для Vim есть плагин
[fzf.vim](https://github.com/junegunn/fzf.vim). Работает быстрее ctrlp. Можно кстати и по истории комитов Git
перемещаться.

## Плагины ниндзя

Следующий набор плагинов определенно заслуживает вашего внимания, ведь они стали стандартом де-факто в мире Vim.
